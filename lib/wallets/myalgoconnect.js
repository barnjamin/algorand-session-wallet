    ...
    signTxn(txns) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let tidx in txns) {
                const txn = txns[tidx];
                if (algosdk_1.default.encodeAddress(txn.from.publicKey) == default_acct) {
