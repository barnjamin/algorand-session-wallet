...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "algosdk"], factory);
    }
    ...
    var AlgoSignerWallet = /** @class */ (function () {
        function AlgoSignerWallet(network) {
            this.network = network;
            this.accounts = [];
            this.defaultAccount = 0;
        }
        AlgoSignerWallet.displayName = function () { return "AlgoSigner"; };
        AlgoSignerWallet.prototype.displayName = function () { return AlgoSignerWallet.displayName(); };
        AlgoSignerWallet.img = function (inverted) {
            return inverted ? logoInverted : logo;
        };
        AlgoSignerWallet.prototype.img = function (inverted) {
            return AlgoSignerWallet.img(inverted);
        };
        AlgoSignerWallet.prototype.connect = function () {
            return __awaiter(this, void 0, void 0, function () {
                var loaded, err_1, accts;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (this.isConnected())
                                return [2 /*return*/, true];
                            return [4 /*yield*/, this.waitForLoaded()];
                        case 1:
                            loaded = _a.sent();
                            if (!loaded) {
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 5];
                        case 5: return [4 /*yield*/, AlgoSigner.accounts({ ledger: this.network })];
                        case 6:
                            accts = _a.sent();
                            this.accounts = accts.map(function (a) { return a.address; });
                            return [2 /*return*/, true];
                    }
                });
            });
        };
        AlgoSignerWallet.prototype.waitForLoaded = function () {
            return __awaiter(this, void 0, void 0, function () {
                var x;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AlgoSignerWallet.prototype.isConnected = function () { return this.accounts && this.accounts.length > 0; };
        AlgoSignerWallet.prototype.disconnect = function () { };
        AlgoSignerWallet.prototype.getDefaultAccount = function () {
            if (!this.isConnected())
                return "";
            return this.accounts[this.defaultAccount];
        };
        AlgoSignerWallet.prototype.signTxn = function (txns) {
            return __awaiter(this, void 0, void 0, function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            encodedTxns = txns.map(function (tx) {
                                var t = { txn: AlgoSigner.encoding.msgpackToBase64(tx.toByte()) };
                                // @ts-ignore
                                if (algosdk_1.default.encodeAddress(tx.from.publicKey) !== defaultAcct)
                                    t.signers = [];
                                return t;
                            });
                            return [4 /*yield*/, AlgoSigner.signTxn(encodedTxns)];
                        case 1:
                            signed = _a.sent();
                            return [2 /*return*/, signed.map(function (signedTx) {
                                    if (signedTx)
                                        return {
                                            txID: signedTx.txID,
        ...
        AlgoSignerWallet.prototype.sign = function (txn) {
            return __awaiter(this, void 0, void 0, function () {
                var stxn, blob;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, AlgoSigner.sign(txn)];
                        case 1:
                            stxn = _a.sent();
                            blob = new Uint8Array(Buffer.from(stxn.blob, 'base64'));
                            return [2 /*return*/, { txID: stxn.txID, blob: blob }];
                    }
                });
            });
        };
        AlgoSignerWallet.prototype.signBytes = function (b) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        AlgoSignerWallet.prototype.signTeal = function (teal) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    throw new Error('Method not implemented.');
                });
